...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="">
            <a href="{{ route('deliveryCoupon.index') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Coupon List</a>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="row">
            <div class="col-md-8 mx-auto">
				<form method="post" action="{{ route('deliveryCoupon.store') }}" enctype="multipart/form-data">
					@csrf
					<div class="card">
			        	...
			        	<div class="card-body">
			        		<div class="row">
			                	<div class="col-md-6 mb-4">
			                        <label for="delivery_code" class="col-form-label" style="font-weight: bold;">Delivery Code:<span class="text-danger">*</span></label>
			                        <input class="form-control" id="delivery_code" type="text" name="delivery_code" placeholder="Write Coupon Code" required>
			                        @error('delivery_code')
		                        ...
		                        <div class="col-md-6 mb-4">
		                          	<label for="expire_date" class="col-form-label" style="font-weight: bold;">Amount Range:</label>
		                            <input class="form-control" id="amount_range" type="number" name="amount_range" min="0" required>
		                        </div>
        	                    <div class="col-md-6 mb-4">
