...
Route::get('/terms-service',[FrontendController::class, 'termService'])->name('terms.service');
...
Route::get('/delivery/coupon/get',[CheckoutController::class,'delivery_coupon_get'])->name('delivery.coupon.get');
/* ============ Cart Get Product   ============= */
...
Route::post('user/addresses/update/{id}', [UserController::class, 'address_update'])->name('user.addresses.update');
// Set_Default Show //
...
//pathao
Route::get('/pathao/init', [PathaoController::class, 'init'])->name('pathao.init');
